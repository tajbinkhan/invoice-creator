...
class SettingsForm(forms.ModelForm):
	def __init__(self, *args, **kwargs):
		...
		self.fields['terms_conditions'].widget.attrs['placeholder'] = 'Website Terms & Conditions...'
		self.fields['privacy_policy'].widget.attrs['placeholder'] = 'Website Privacy Policy...'
